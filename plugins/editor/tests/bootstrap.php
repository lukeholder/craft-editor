...
define('CRAFT_BASE_PATH', realpath(str_replace("plugins/editor", '', exec('pwd'))).'/');
...
// Load plugin
require_once CRAFT_PLUGINS_PATH.'editor/EditorPlugin.php';
require_once CRAFT_PLUGINS_PATH.'editor/vendor/autoload.php';
